...
نمای کلی فروش، سفارش و وضعیت فروشگاه.
...
Page pattern: **dashboard**. Loading, empty, validation, success, and error states should be preserved when the real service is connected.
