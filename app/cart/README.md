...
مدیریت اقلام، تعداد، تخفیف و جمع سفارش.
...
Page pattern: **cart**. Loading, empty, validation, success, and error states should be preserved when the real service is connected.
