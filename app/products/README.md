...
فهرست کامل محصولات با فیلتر و مرتب‌سازی.
...
Page pattern: **catalog**. Loading, empty, validation, success, and error states should be preserved when the real service is connected.
